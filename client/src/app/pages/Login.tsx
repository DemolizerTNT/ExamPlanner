...
export function Login() {
  ...
  return (
    <div className="min-h-screen flex">
      ...
      <div className="flex-1 flex items-center justify-center p-8 bg-[#f0f4f9]">
        <motion.div
              ...
              <div className="relative">
                ...
                <input
                  ...
                  onChange={e => setEmail(e.target.value)}
                    placeholder="E-mail"
                  className="w-full pl-10 pr-4 py-3 rounded-xl border-2 border-[#003366] bg-white text-gray-900 focus:outline-none focus:ring-2 focus:ring-[#003366]/30 focus:border-[#003366] transition-all"
